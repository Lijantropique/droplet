...
def test_boundaries_extreme():
    ...
    with pytest.raises(ValueError):
        droplet(temperature=273.14999, pressure=100)
    with pytest.raises(ValueError):
        droplet(temperature=1073.15001, pressure=100)
    with pytest.raises(ValueError):
        droplet(temperature=1073.14999, pressure=50)
    with pytest.raises(ValueError):
        droplet(temperature=2273.15001, pressure=50)

def test_boundaries_temperature():
    """DOC"""
    n = 10 # number of points in each dimension

    temperature = np.linspace(0, 273.14, n)
    ...
    temperature = np.linspace(1073.16, 2273.15, n)
    pressure = np.linspace(50, 100, n)
    tv, pv = np.meshgrid(temperature, pressure)
    for pair in zip(tv.ravel(),pv.ravel()):
        with pytest.raises(ValueError):
            droplet(*pair)

    temperature = np.linspace(2273.16, 3000, n)
    pressure = np.linspace(0, 100, n)
    tv, pv = np.meshgrid(temperature, pressure)
    for pair in zip(tv.ravel(),pv.ravel()):
        with pytest.raises(ValueError):
...
def test_boundaries_pressure():
    ...
    pressure = np.linspace(100, 200, n)
    tv, pv = np.meshgrid(temperature, pressure)
    for pair in zip(tv.ravel(),pv.ravel()):
        with pytest.raises(ValueError):
            droplet(*pair)

    temperature = np.linspace(1073.15, 2273.15, n)
    pressure = np.linspace(50, 100, n)
    tv, pv = np.meshgrid(temperature, pressure)
    for pair in zip(tv.ravel(),pv.ravel()):
        with pytest.raises(ValueError):
...
def test_boundary2_3():
    drop = droplet(temperature=0.623150000E3)
    assert (drop.pressure - 0.165291643E2) <= TOL
    drop = droplet(pressure=0.165291643E2)
    assert (drop.temperature - 0.623150000E3) <= TOL

def test_region1_1():
    drop = droplet(temperature=300, pressure=3)
...
def test_region1_2():
    drop = droplet(temperature=300, pressure=80)
    assert drop.region == 'Region1'
...
def test_region1_3():
    drop = droplet(temperature=500, pressure=3)
    assert drop.region == 'Region1'
...
def test_region2_1():
    drop = droplet(temperature=300, pressure=0.0035)
...
def test_region2_2():
    drop = droplet(temperature=700, pressure=0.0035)
    assert drop.region == 'Region2'
...
def test_region2_3():
    drop = droplet(temperature=700, pressure=30)
    assert drop.region == 'Region2'
...
def test_region2Meta_1():
    drop = droplet(temperature=450, pressure=1)
...
def test_region2Meta_2():
    drop = droplet(temperature=440, pressure=1)
    assert drop.region == 'Region2-Meta'
...
def test_region2Meta_3():
    drop = droplet(temperature=450, pressure=1.5)
    assert drop.region == 'Region2-Meta'
...
def test_region3_1():
    drop = droplet(temperature=650, pressure=0.255837018e2)
...
def test_region3_2():
    drop = droplet(temperature=650, pressure=0.222930643e2)
    assert drop.region == 'Region3'
...
def test_region3_3():
    drop = droplet(temperature=750, pressure=0.783095639e2)
    assert drop.region == 'Region3'
    assert (drop.v - 1/500) <= TOL
...
def test_region5_1():
    drop = droplet(temperature=1500, pressure=0.5)
...
def test_region5_2():
    drop = droplet(temperature=1500, pressure=30.0)
    assert drop.region == 'Region5'
...
def test_region5_3():
    drop = droplet(temperature=2000, pressure=30.0)
    assert drop.region == 'Region5'
